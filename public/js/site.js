...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('darkMode', {
  ...
  on: alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].$persist(true).as('darkMode_on'),
...
document.addEventListener('alpine:init', function () {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('darkMode', {
    ...
    on: alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].persist(false).as('darkMode_on'),
    toggle: function toggle() {
      this.on = !this.on;
    }
  });
